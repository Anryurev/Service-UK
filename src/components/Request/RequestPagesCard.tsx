...
export interface IRequestPagesCard{
    request: IRequest
    fromReport: boolean
}

export function RequestPagesCard({request, fromReport}: IRequestPagesCard) {
        ...
        <>
            <Card className="shadow-sm">
                ...
                <Card.Body>
                    ...
                    {/* Кнопки действий */}
                    {!fromReport && <div className="d-flex justify-content-between mt-4">
