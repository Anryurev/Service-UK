                ...
                <div className="container my-3">
                    <div className="row">
                        <div className="col-sm-8 text-center d-flex align-items-center">
                            <h5 className="mb-1">
                                <strong>Задание: </strong> {request?.request_Id}
                            </h5>
                        </div>
                        ...
                        <div className="col-sm-8">
                            <ul className="list-group list-group-flush">
                                ...
                                <li className="list-group-item">
                                    <strong>Должность: </strong>{role?.name}
                                </li>
                                <li className="list-group-item">
                                ...
                                <li className="list-group-item">
                                    <strong>Описание:</strong> Тут будет подробное описание задания
                                </li>
                            </ul>
                            <div>
                                <h1>Тут будут выводиться фоторграфии</h1>
                                //TODO Сделать вывод фотографий и описания
                            </div>
                        </div>
                        <div
